...
echo "› Seeding pages for Ridgeline Realty…"
...
CONTACT=$(mkpage contact "Contact & Schedule a Showing" "template-contact.blade.php")
LISTINGS=$(mkpage listings "Homes for Sale in Gettysburg & Adams County" "template-listings.blade.php")
SELL=$(mkpage sell "Sell Your Home in Gettysburg & Adams County" "template-sell.blade.php")

wp option update show_on_front page >/dev/null
wp option update page_on_front "$HOME_ID" >/dev/null
wp option update blogname "Ridgeline Realty" >/dev/null 2>&1 || true
