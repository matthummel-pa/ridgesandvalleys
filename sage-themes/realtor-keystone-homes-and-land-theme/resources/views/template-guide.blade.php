{{--
  Template Name: Land Buyer's Guide
--}}
...
<script type="application/ld+json">
{
  ...
  "geo":{"@@type":"GeoCoordinates","latitude":39.8317,"longitude":-77.2319},
...
<script type="application/ld+json">
{
  ...
  "itemListElement":[
    ...
    {"@@type":"ListItem","position":2,"name":"Land Buyer's Guide","item":"{{ home_url('/guide/') }}"}
  ]
}
</script>
@endpush
...
<header class="site-header">
  <div class="header-inner">
    ...
    <nav class="main-nav" aria-label="Primary">
      <ul>
        ...
        <li><a href="{{ home_url('/guide/') }}" class="is-active" aria-current="page">Land Buyer's Guide</a></li>
    ...
    <div class="header-cta">
      ...
      <a class="btn btn-primary btn-sm" href="#schedule">Book a Call</a>
    </div>
  ...
  <nav class="mobile-nav" id="mobileNav" aria-label="Mobile">
    ...
    <a href="{{ home_url('/guide/') }}" class="is-active" aria-current="page">Land Buyer's Guide</a>
    <a href="{{ home_url('/agents/') }}">Our Agents</a>
    <a href="{{ home_url('/contact/') }}">Contact</a>
    <a class="header-phone" href="tel:+17175550455">Call (717) 555-0455</a>
    <a class="btn btn-primary" href="#schedule">Book a Call</a>
  </nav>
</header>
...
<section class="page-hero">
  <div class="page-hero-inner">
    <p class="hero-eyebrow">Buying Land in Adams County</p>
    <h1>The Land Buyer's Guide <em>for Gettysburg &amp; Adams County</em></h1>
    <p>Buying raw land or a small farm isn't like buying a house in town. Wells, septic, perc tests, easements and land loans all come into play. Here's the plain-language version — plus the tools to run your numbers.</p>
  </div>
</section>
    ...
    <div class="wrap">
      ...
      <div class="support-grid" style="margin-top:28px;">
        <div class="tool-card reveal" id="schedule">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> Request Info / Book a Call</h3>
  ...
  <section class="section">
    <div class="wrap">
      ...
      <div class="faq-list reveal">
        <div class="faq-item">
          <h3>How much land do I need for a house and a well and septic?</h3>
        ...
        <div class="faq-item">
          <h3>What's a perc test and who pays for it?</h3>
    ...
    <div class="wrap">
      <div class="cta-band reveal">
        ...
        <div class="cta-actions">
          <a class="btn btn-gold" href="#schedule">Book a Call</a>
