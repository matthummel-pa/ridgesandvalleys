...
<header class="site-header" id="siteHeader">
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="Primary">
      <ul>
        ...
        <li><a href="{{ home_url('/area/') }}" aria-current="page" class="is-active">The Area</a></li>
  ...
  <nav class="mobile-nav" id="mobileNav" aria-label="Mobile">
    ...
    <a href="{{ home_url('/area/') }}" aria-current="page">The Area</a>
  ...
  <section class="page-hero">
    ...
    <div class="container">
      <div class="page-hero-inner">
        ...
        <h1>Everything worth walking to <em>in Gettysburg.</em></h1>
        <p class="lede">The Cupola &amp; Field Hotel sits at 88 Steinwehr Avenue — one of the most walkable addresses in Gettysburg. From our door you can reach Lincoln Square, the National Military Park, and restaurant row on foot.</p>
        <div class="hero-actions"><a href="{{ home_url('/reservations/') }}" class="btn btn-gold">Plan Your Stay</a><a href="{{ home_url('/contact/') }}" class="btn btn-outline">Get Directions</a></div>
      </div>
    </div>
  </section>
  ...
  <section id="walkable">
    <div class="container">
      <div class="location-grid">
        <div class="reveal">
          <div class="prose">
            <span class="eyebrow">Our Neighborhood</span>
            <h2 style="margin-top:.5rem; font-size:clamp(1.7rem,1.2rem + 2vw,2.4rem);">Walkable from Steinwehr Avenue</h2>
            <p>Steinwehr Avenue is Gettysburg's front porch — the street where the town meets the battlefield. Step out of the hotel and you're on the edge of the Gettysburg National Military Park, with the Soldiers' National Cemetery and the David Wills House both a short stroll away. Head north and Steinwehr becomes Baltimore Street, carrying you the half mile up to <strong>Lincoln Square</strong>, the historic heart of town.</p>
            <p>Because everything clusters so tightly here, most guests park once and leave the car until checkout. The <strong>Gettysburg National Military Park Museum &amp; Visitor Center</strong> is about a 15-minute walk or a five-minute pedal on one of our complimentary cruiser bikes. The paved auto-tour road that loops past the Pennsylvania Memorial, Little Round Top, and Seminary Ridge begins just beyond it.</p>

            <h3>Landmarks within a short walk</h3>
            <ul class="plain">
              <li><strong>Soldiers' National Cemetery</strong> — where Lincoln delivered the Gettysburg Address, about 5 minutes on foot.</li>
              <li><strong>David Wills House</strong> — the home where Lincoln finished the Address, on Lincoln Square, roughly a 10-minute walk.</li>
              <li><strong>Shriver House Museum</strong> — a civilian home preserved from the battle, on Baltimore Street, about 6 minutes away.</li>
              <li><strong>Steinwehr Avenue restaurant row</strong> — a dozen kitchens, taverns, and ice-cream stops within four blocks of the lobby.</li>
              <li><strong>Seminary Ridge &amp; the Lutheran Seminary</strong> — a scenic 20-minute walk west, or a quick ride.</li>
            </ul>

            <h3>Driving directions</h3>
            <p>From the north or south, take <strong>US-15</strong> to the Steinwehr Avenue / Business Route 15 exit and follow signs toward the Visitor Center; the hotel is on Steinwehr Avenue just before Lincoln Square. From the east or west, <strong>US-30 (York Street / Chambersburg Street)</strong> leads straight into Lincoln Square — turn south and Steinwehr Avenue is two blocks down. We're roughly 45 minutes from Harrisburg, an hour from York and Frederick, and about 90 minutes from Baltimore and Washington, D.C.</p>

            <h3>Parking</h3>
            <p>The hotel offers on-site valet parking for $28/night just off Steinwehr Avenue. If you'd rather self-park, a municipal lot two blocks away runs about $12/night, and metered street parking is available around Lincoln Square during the day. Once you've parked, the whole downtown is comfortably walkable.</p>

            <h3>Day trips around Adams County</h3>
            <p>Gettysburg is the anchor, but Adams County rewards a wider loop. <strong>Biglerville</strong> and the surrounding orchards, ten minutes north, are the heart of Pennsylvania apple country and home to the National Apple Museum. <strong>Cashtown</strong> and <strong>Fairfield</strong> sit along the historic roads the armies used in 1863, each with a landmark inn. To the east, <strong>New Oxford</strong> is known for its antique shops and traffic circle, while <strong>Hanover</strong> and <strong>McSherrystown</strong> offer more dining and the Hanover cavalry-battle sites. <strong>Littlestown</strong>, to the southeast, makes an easy detour toward the Maryland line. Our front desk is happy to map a route — just ask.</p>
          </div>
        </div>

        <div class="nearby-list reveal">
          <div class="nearby-item"><span class="dist">0.1 mi</span><div><h4>Gettysburg National Military Park (edge)</h4><p>Steinwehr Avenue runs right along the park boundary and cemetery.</p></div></div>
          <div class="nearby-item"><span class="dist">0.3 mi</span><div><h4>Visitor Center &amp; Museum</h4><p>Cyclorama, film, and the start of the auto-tour route — a 15-min walk.</p></div></div>
          <div class="nearby-item"><span class="dist">0.5 mi</span><div><h4>Lincoln Square</h4><p>The historic center of town, ringed with shops and the David Wills House.</p></div></div>
          <div class="nearby-item"><span class="dist">0.3 mi</span><div><h4>Soldiers' National Cemetery</h4><p>Site of the Gettysburg Address, a short walk from the lobby.</p></div></div>
          <div class="nearby-item"><span class="dist">0.4 mi</span><div><h4>Baltimore Street Shops</h4><p>Independent bookstores, galleries, and antique dealers.</p></div></div>
          <div class="nearby-item"><span class="dist">10 min</span><div><h4>Biglerville Orchards</h4><p>Apple country and the National Apple Museum, a short drive north.</p></div></div>
        </div>
      </div>
    </div>
  </section>

  <section class="section-alt" id="getting-here">
    <div class="container">
      <div class="section-head reveal">
        <span class="eyebrow">Getting Here</span>
        <h2>By car, on foot, and everything between</h2>
      </div>
      <div class="info-grid">
        <div class="info-card reveal"><h3><svg class="icon" aria-hidden="true"><use href="#i-map"></use></svg> From US-15</h3><p>Exit at Steinwehr Avenue / Business 15 and follow Visitor Center signs. The hotel is on Steinwehr just before Lincoln Square, on your right.</p></div>
        <div class="info-card reveal"><h3><svg class="icon" aria-hidden="true"><use href="#i-map"></use></svg> From US-30</h3><p>Follow York or Chambersburg Street into Lincoln Square, then turn south; Steinwehr Avenue is two blocks down. About 45 min from Harrisburg.</p></div>
        <div class="info-card reveal"><h3><svg class="icon" aria-hidden="true"><use href="#i-valet"></use></svg> Parking</h3><p>On-site valet $28/night, self-park municipal lot two blocks away ~$12/night, plus metered street parking around the Square by day.</p></div>
        <div class="info-card reveal"><h3><svg class="icon" aria-hidden="true"><use href="#i-bike"></use></svg> On two wheels &amp; on foot</h3><p>Borrow a complimentary cruiser for the paved battlefield loop, or walk to the Visitor Center in about 15 minutes.</p></div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="cta-band reveal">
        ...
        <p>88 Steinwehr Avenue puts Gettysburg's landmarks, restaurants, and the battlefield within walking distance. Book direct and settle in.</p>
        <div class="hero-actions">
          <a href="{{ home_url('/reservations/') }}" class="btn btn-gold">Check Availability</a>
          <a href="{{ home_url('/amenities/') }}" class="btn btn-outline">See Amenities</a>
        </div>
      </div>
    </div>
  </section>
