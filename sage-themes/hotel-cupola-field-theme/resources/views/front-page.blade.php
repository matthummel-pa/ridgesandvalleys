...
<header class="site-header" id="siteHeader">
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="Primary">
      <ul>
        <li><a href="{{ home_url('/') }}" aria-current="page" class="is-active">Home</a></li>
  ...
  <nav class="mobile-nav" id="mobileNav" aria-label="Mobile">
    <a href="{{ home_url('/') }}" aria-current="page">Home</a>
...
<main id="main">
  ...
  <section class="hero">
    <div class="hero-media">
      <img src="https://commons.wikimedia.org/wiki/Special:FilePath/DowntownGettysburgPA.jpg?width=1600"
           alt="A tree-lined street of historic brick storefronts in downtown Gettysburg, Pennsylvania"
    ...
    <div class="container">
      <div class="hero-inner">
        <span class="hero-badge">
          ...
          On Steinwehr Avenue · Gettysburg, PA
        </span>
        <h1>A modern retreat, <em>steps from history.</em></h1>
        <p class="lede">Twenty-eight boutique rooms, a rooftop cupola lounge, and a front desk that knows the battlefield trails as well as the best table on Steinwehr Avenue. Welcome to Gettysburg, reimagined.</p>
        <div class="hero-actions">
          <a href="{{ home_url('/reservations/') }}" class="btn btn-gold">Check Availability</a>
          <a href="{{ home_url('/rooms/') }}" class="btn btn-ghost">View Rooms</a>
        </div>
        <div class="hero-stats">
          <div><strong>28</strong><span>Boutique Rooms</span></div>
          <div><strong>0.5mi</strong><span>To Lincoln Square</span></div>
          <div><strong>4.9</strong><span>Sample Rating</span></div>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="story-grid">
        <div class="story-media reveal">
          <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Two_Buildings_in_the_Gettysburg_Historic_District.jpg?width=1600"
               alt="Two adjoining historic brick buildings with tall windows in Gettysburg's downtown historic district"
               onerror="this.style.display='none'">
          <span class="story-media-tag">Est. in a restored 1887 storefront</span>
        </div>
        <div class="story-copy reveal">
          <span class="eyebrow">Our Story</span>
          <h2 style="margin-top:.6rem; font-size:clamp(1.7rem, 1.2rem + 2vw, 2.4rem);">Where the cupola once watched for weather, we now watch for you.</h2>
          <p>The Cupola &amp; Field Hotel occupies a row of restored storefronts on Steinwehr Avenue, a short walk from Lincoln Square. We kept the tin ceilings and the rooftop cupola that gave the building its name, and built a modern, design-forward hotel underneath it.</p>
          <p>Our team grew up in Adams County. We can tell you which battlefield overlook catches the best sunrise, which diner opens earliest, and which orchard stand outside Biglerville has peaches in by July.</p>
          <blockquote class="pull">
            "We didn't want a hotel that felt like anywhere. We wanted one that could only be Gettysburg."
            <cite>— Founder, The Cupola &amp; Field Hotel</cite>
          </blockquote>
        </div>
      </div>
    </div>
  ...
  <section class="section-alt" id="explore">
    <div class="container">
      <div class="section-head reveal">
        ...
        <h2>Everything you need, one page away</h2>
        <p>Explore our rooms, book real-time dates, browse amenities, and learn what's walkable from our door on Steinwehr Avenue.</p>
      </div>
      <div class="teaser-grid">
        <article class="teaser-card reveal">
          <div class="amenity-icon"><svg class="icon" aria-hidden="true"><use href="#i-bed"></use></svg></div>
          <h3>Rooms &amp; Suites</h3>
          <p>Four room types from the Heritage Double to the Cupola Loft — custom millwork, Nespresso bars, and blackout linen drapery.</p>
          <a class="tlink" href="{{ home_url('/rooms/') }}">View rooms <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></a>
        </article>
        <article class="teaser-card reveal">
          <div class="amenity-icon"><svg class="icon" aria-hidden="true"><use href="#i-clock"></use></svg></div>
          <h3>Reservations</h3>
          <p>Check real-time nightly rates and totals for your dates, guests, and room type with our live booking engine.</p>
          <a class="tlink" href="{{ home_url('/reservations/') }}">Check availability <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></a>
        </article>
        <article class="teaser-card reveal">
          <div class="amenity-icon"><svg class="icon" aria-hidden="true"><use href="#i-wine"></use></svg></div>
          <h3>Amenities &amp; Concierge</h3>
          <p>Rooftop lounge, complimentary breakfast, battlefield bike rentals, and a concierge who knows Adams County.</p>
          <a class="tlink" href="{{ home_url('/amenities/') }}">See amenities <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></a>
        </article>
        <article class="teaser-card reveal">
          <div class="amenity-icon"><svg class="icon" aria-hidden="true"><use href="#i-map"></use></svg></div>
          <h3>The Area</h3>
          <p>Walking distances to Lincoln Square and the Military Park, driving directions, parking, and nearby Adams County towns.</p>
          <a class="tlink" href="{{ home_url('/area/') }}">Explore Gettysburg <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></a>
        </article>
        <article class="teaser-card reveal">
          <div class="amenity-icon"><svg class="icon" aria-hidden="true"><use href="#i-pin"></use></svg></div>
          <h3>Find &amp; Contact Us</h3>
          <p>We're at 88 Steinwehr Avenue, Gettysburg. Message the front desk, get directions, or call us any time — the desk is staffed 24/7.</p>
          <a class="tlink" href="{{ home_url('/contact/') }}">Contact the desk <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></a>
        </article>
        <article class="teaser-card reveal">
          <div class="amenity-icon"><svg class="icon" aria-hidden="true"><use href="#i-bike"></use></svg></div>
          <h3>Battlefield Bikes</h3>
          <p>Borrow a complimentary cruiser for the paved loop through Gettysburg National Military Park — details on the amenities page.</p>
          <a class="tlink" href="{{ home_url('/amenities/') }}">Plan a ride <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></a>
        </article>
      </div>
    </div>
  </section>
  ...
  <section class="stat-banner">
    <div class="hero-media">
      <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Cumberland_Valley_Pennsylvania.jpg?width=1600"
           alt="Rolling farmland and ridgelines of the Cumberland Valley near Gettysburg, Pennsylvania"
           onerror="this.style.display='none'">
    </div>
    <div class="container">
      <div class="stat-grid reveal">
        <div><strong>1863</strong><span>Town's Turning Point</span></div>
        <div><strong>28</strong><span>Rooms, Never Crowded</span></div>
        <div><strong>0.5mi</strong><span>To Lincoln Square</span></div>
        <div><strong>4.9 / 5</strong><span>Sample Guest Rating</span></div>
      </div>
    </div>
  </section>
  ...
  <section class="section-alt" id="reviews">
    <div class="container">
      <div class="section-head reveal">
        ...
        <p>Illustrative sample reviews for this concept — first name and trip type only.</p>
      </div>
      <div class="testi-grid">
        <div class="testi-card reveal">
          <div class="stars" aria-hidden="true">
            <svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg>
          </div>
          <span class="visually-hidden">Rated 5 out of 5 stars</span>
          <blockquote>"The rooftop lounge at sunset, looking toward Seminary Ridge, is worth the trip on its own. The room itself felt like a boutique hotel twice the price."</blockquote>
          <footer>Dana M. — Anniversary Stay, Cupola Loft</footer>
        </div>
        <div class="testi-card reveal">
          <div class="stars" aria-hidden="true">
            <svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg>
          ...
          <span class="visually-hidden">Rated 5 out of 5 stars</span>
          <blockquote>"Front desk got us a dinner reservation on Steinwehr Avenue with two hours' notice and had bikes ready for the battlefield loop by 8am. Genuinely helpful, not scripted."</blockquote>
          <footer>James R. — Weekend Trip, Field Suite</footer>
        </div>
        <div class="testi-card reveal">
          <div class="stars" aria-hidden="true">
            <svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg><svg class="icon"><use href="#i-star"></use></svg>
          ...
          <span class="visually-hidden">Rated 5 out of 5 stars</span>
          <blockquote>"We brought our dog and nobody blinked. Walked everywhere — the Square, the museum, dinner — and never needed the car once we parked it."</blockquote>
          <footer>Priya &amp; Alex — Long Weekend, Heritage Double</footer>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="cta-band reveal">
        ...
        <h2>Your Gettysburg stay starts here</h2>
        <p>Check live rates for your dates, or call the front desk at (717) 555-0188 — we're staffed around the clock at 88 Steinwehr Avenue.</p>
        <div class="hero-actions">
          <a href="{{ home_url('/reservations/') }}" class="btn btn-gold">Check Availability</a>
          <a href="{{ home_url('/contact/') }}" class="btn btn-outline">Contact the Desk</a>
        </div>
      </div>
    </div>
  </section>
