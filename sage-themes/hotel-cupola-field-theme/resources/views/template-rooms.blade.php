...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@@type": "ListItem", "position": 2, "name": "Rooms &amp; Suites", "item": "{{ home_url('/rooms/') }}" }
  ]
}
</script>
@endpush
...
<header class="site-header" id="siteHeader">
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="Primary">
      <ul>
        ...
        <li><a href="{{ home_url('/rooms/') }}" aria-current="page" class="is-active">Rooms</a></li>
  ...
  <nav class="mobile-nav" id="mobileNav" aria-label="Mobile">
    ...
    <a href="{{ home_url('/rooms/') }}" aria-current="page">Rooms</a>
...
<nav class="breadcrumb" aria-label="Breadcrumb">
  <div class="container">
    <ol>
      ...
      <li aria-current="page">Rooms &amp; Suites</li>
    </ol>
  </div>
</nav>
  ...
  <section class="page-hero">
    ...
    <div class="container">
      <div class="page-hero-inner">
        ...
        <h1>Rooms &amp; suites, <em>built for the way you travel.</em></h1>
        <p class="lede">Twenty-eight rooms across four distinct layouts. Every room pairs custom millwork with a Gettysburg-made wool throw, a Nespresso bar, and blackout linen drapery — a few steps from Lincoln Square and the Military Park.</p>
        <div class="hero-actions"><a href="{{ home_url('/reservations/') }}" class="btn btn-gold">Check Availability</a><a href="{{ home_url('/amenities/') }}" class="btn btn-outline">See Amenities</a></div>
      </div>
    </div>
  </section>
  ...
  <section id="rooms">
    <div class="container">
      <div class="section-head reveal">
        ...
        <h2>Four ways to stay in Gettysburg</h2>
        <p>Rates are demo estimates for this concept. Choose "Reserve" to jump to our live reservation engine with your room pre-selected.</p>
      </div>

      <div class="rooms-grid">
        <article class="room-card reveal">
          <div class="room-photo p4"><span class="room-price-tag">$189/night</span></div>
          <div class="room-body">
            <h3>Heritage Double</h3>
            <p class="room-meta">Two queens · 300 sq ft · Classic quarter</p>
            <div class="chip-row"><span class="chip">Two queens</span><span class="chip">Work nook</span><span class="chip">Pet-friendly</span></div>
            <div class="room-foot"><span class="price">$189 <small>/ night</small></span><a class="btn btn-outline btn-sm" href="reservations.html?room=heritage">Reserve</a></div>
          </div>
        </article>
        <article class="room-card reveal">
          <div class="room-photo p2"><span class="room-price-tag">$219/night</span></div>
          <div class="room-body">
            <h3>Ridge King</h3>
            <p class="room-meta">King bed · 340 sq ft · Valley view</p>
            <div class="chip-row"><span class="chip">King bed</span><span class="chip">Valley view</span><span class="chip">Nespresso bar</span></div>
            <div class="room-foot"><span class="price">$219 <small>/ night</small></span><a class="btn btn-outline btn-sm" href="reservations.html?room=ridge">Reserve</a></div>
          </div>
        </article>
        <article class="room-card reveal">
          <div class="room-photo p1"><span class="room-price-tag">$259/night</span></div>
          <div class="room-body">
            <h3>Field Suite</h3>
            <p class="room-meta">King bed · 420 sq ft · Garden balcony</p>
            <div class="chip-row"><span class="chip">King bed</span><span class="chip">Balcony</span><span class="chip">Soaking tub</span></div>
            <div class="room-foot"><span class="price">$259 <small>/ night</small></span><a class="btn btn-outline btn-sm" href="reservations.html?room=field">Reserve</a></div>
          </div>
        </article>
        <article class="room-card reveal">
          <div class="room-photo p3"><span class="room-price-tag">$299/night</span></div>
          <div class="room-body">
            <h3>Cupola Loft</h3>
            <p class="room-meta">Two queens · 520 sq ft · Private skylight</p>
            <div class="chip-row"><span class="chip">Skylight lounge</span><span class="chip">Wet bar</span><span class="chip">Record player</span></div>
            <div class="room-foot"><span class="price">$299 <small>/ night</small></span><a class="btn btn-outline btn-sm" href="reservations.html?room=cupola">Reserve</a></div>
          </div>
        </article>
      </div>
    </div>
    ...
    <div class="container">
      <div class="story-grid">
        <div class="story-copy reveal">
          <span class="eyebrow">In Every Room</span>
          <h2 style="margin-top:.6rem; font-size:clamp(1.6rem,1.2rem + 1.8vw,2.3rem);">Boutique details, quietly done</h2>
          <p>We furnished all 28 rooms the way we'd want our own guest room: firm mattresses with linen bedding, blackout drapery for late battlefield-sunrise nights, and a small Nespresso bar for the early ones. Wool throws are woven right here in Adams County.</p>
          <ul class="plain" style="margin-top:18px; display:flex; flex-direction:column; gap:8px; list-style:none; padding:0;">
            <li style="color:var(--ink-soft);">Gigabit fiber Wi-Fi throughout the building</li>
            <li style="color:var(--ink-soft);">Complimentary breakfast, 7&ndash;10:30am daily</li>
            <li style="color:var(--ink-soft);">Smart TVs, USB-C charging, and blackout drapes</li>
            <li style="color:var(--ink-soft);">Two Heritage Doubles welcome dogs ($35/night)</li>
          </ul>
        </div>
        <div class="story-media reveal">
          <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Two_Buildings_in_the_Gettysburg_Historic_District.jpg?width=1600"
               alt="Restored historic brick buildings with tall windows housing the Cupola and Field Hotel in Gettysburg"
               onerror="this.style.display='none'">
          <span class="story-media-tag">Restored storefronts on Steinwehr Ave</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="room-faq">
    <div class="container">
      <div class="section-head reveal">
        <span class="eyebrow">Room Questions</span>
        <h2>Good to know before you book</h2>
      </div>
      <div class="faq-list">
        <div class="faq-item reveal">
          <button class="faq-q" aria-expanded="false" aria-controls="rfaq-1">Which rooms are best for families? <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></button>
          <div class="faq-a" id="rfaq-1" data-open="false"><p>The Heritage Double (two queens) and the Cupola Loft (two queens plus a skylight lounge) suit families best. We provide cribs and pack-n-plays free of charge — just ask the front desk at (717) 555-0188.</p></div>
        </div>
        <div class="faq-item reveal">
          <button class="faq-q" aria-expanded="false" aria-controls="rfaq-2">Do any rooms have a view of the battlefield? <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></button>
          <div class="faq-a" id="rfaq-2" data-open="false"><p>The Ridge King rooms look west toward the valley and Seminary Ridge, and the rooftop Cupola Lounge has open sightlines over Steinwehr Avenue toward the National Military Park.</p></div>
        </div>
        <div class="faq-item reveal">
          <button class="faq-q" aria-expanded="false" aria-controls="rfaq-3">Are the rooms accessible? <svg class="icon" aria-hidden="true"><use href="#i-chevron"></use></svg></button>
          <div class="faq-a" id="rfaq-3" data-open="false"><p>Yes — we have step-free entry from Steinwehr Avenue, an elevator to every floor, and accessible Heritage Double rooms with roll-in showers. Call ahead and we'll match you to the right room.</p></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container">
      <div class="cta-band reveal">
        ...
        <h2>Ready to pick your room?</h2>
        <p>Head to the reservation engine to see live nightly rates and totals for your dates, or call the front desk at (717) 555-0188.</p>
        <div class="hero-actions">
          <a href="{{ home_url('/reservations/') }}" class="btn btn-gold">Check Availability</a>
          <a href="{{ home_url('/area/') }}" class="btn btn-outline">Explore the Area</a>
        </div>
      </div>
    </div>
  </section>
