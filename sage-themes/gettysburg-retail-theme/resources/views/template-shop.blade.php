{{--
  Template Name: Shop Locally Made Gifts Online
--}}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@@type": "ListItem", "position": 2, "name": "Shop", "item": "{{ home_url('/shop/') }}" }
  ]
}
</script>
@endpush
...
<header class="site-header">
  <div class="wrap header-inner">
    ...
    <nav class="main-nav" aria-label="Primary">
      <ul>
        <li><a href="{{ home_url('/shop/') }}" class="is-active" aria-current="page">Shop</a></li>
...
<nav class="mobile-menu" id="mobileMenu" aria-label="Mobile" aria-hidden="true">
  ...
  <ul>
    <li><a href="{{ home_url('/shop/') }}" class="mobile-link is-active">Shop</a></li>
...
<main id="main">
  ...
  <section class="page-hero">
    <div class="wrap">
      ...
      <h1>Shop locally made goods from <em>downtown Gettysburg</em></h1>
      <p>Every piece is made by an Adams County maker and ships from our York Street storefront within two business days. Add to your bag and check out right here — or pick it up in-store the same day.</p>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      <div class="section-head-row reveal">
        ...
        <p style="max-width:34ch;color:var(--ink-soft);margin:0;">Candles, apparel, ceramics, pantry goods and books — a rotating selection of what our neighbors are making this season.</p>
      </div>
      <div class="product-grid" id="productGrid">
        ...
        <article class="product-card reveal">
          <div class="product-media pm-2"><svg viewBox="0 0 200 200" aria-hidden="true"><circle cx="100" cy="100" r="45" fill="rgba(255,253,249,0.9)"/></svg></div>
          <div class="product-body">
            <span class="product-cat">Local Gifts</span>
            <h3 class="product-name">Steinwehr Ave Sticker Pack</h3>
            <div class="product-foot">
              <span class="product-price price">$8.00</span>
              <button class="add-btn" data-name="Steinwehr Ave Sticker Pack" data-price="8.00"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg> Add</button>
            </div>
          </div>
        </article>
      </div>
      <p class="divider-note">Prices in USD. Free shipping on orders over $75 · same-day in-store pickup at 33 York Street.</p>
    </div>
  </section>
  ...
  <section style="background:var(--cream-deep);border-block:1px solid var(--line);">
    <div class="wrap">
      <div class="section-head reveal">
        ...
        <h2>Prefer to browse by category?</h2>
      </div>
      <div class="collections-grid">
        <a class="collection-tile ct-1 reveal" href="{{ home_url('/collections/') }}"><span>24 pieces</span><h3>Candles</h3></a>
        <a class="collection-tile ct-2 reveal" href="{{ home_url('/collections/') }}"><span>18 pieces</span><h3>Apparel</h3></a>
        <a class="collection-tile ct-3 reveal" href="{{ home_url('/collections/') }}"><span>31 pieces</span><h3>Home Goods</h3></a>
        <a class="collection-tile ct-4 reveal" href="{{ home_url('/collections/') }}"><span>27 pieces</span><h3>Local Gifts</h3></a>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      <div class="section-head reveal"><span class="eyebrow">Good To Know</span><h2>Shopping &amp; shipping questions</h2></div>
      <div class="faq-list">
        <div class="faq-item reveal"><h3>Can I pick up my online order in-store?</h3><p>Yes. Choose in-store pickup at checkout and your order is usually ready within an hour at 33 York Street, Gettysburg. We'll hold it at the counter for seven days.</p></div>
        <div class="faq-item reveal"><h3>How fast do you ship?</h3><p>Orders placed by 2 pm ship the same business day from our York Street back room. Free shipping kicks in on orders over $75.</p></div>
        <div class="faq-item reveal"><h3>Is everything really made locally?</h3><p>Every item is made by a maker in Gettysburg or elsewhere in Adams County — you can meet many of them on our <a href="{{ home_url('/about/') }}" style="color:var(--terracotta-dk);font-weight:600;">Local Makers</a> page.</p></div>
        <div class="faq-item reveal"><h3>Do you gift wrap?</h3><p>We do — add a note at checkout or ask at the counter. We also build custom gift boxes for weddings and reunions; just <a href="{{ home_url('/contact/') }}" style="color:var(--terracotta-dk);font-weight:600;">get in touch</a>.</p></div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      <div class="cta-band reveal">
        <span class="eyebrow" style="color:var(--gold-lt);justify-content:center;display:inline-flex;">Rather shop in person?</span>
        <h2>We're two minutes from Lincoln Square</h2>
        <p>Come see (and smell) it all at 33 York Street in downtown Gettysburg. Open seven days a week.</p>
        <div class="hero-ctas"><a href="{{ home_url('/visit/') }}" class="btn btn-light">Directions &amp; hours</a><a href="{{ home_url('/contact/') }}" class="btn btn-outline" style="color:var(--cream);border-color:var(--cream);">Ask a question</a></div>
      </div>
    </div>
  </section>
