...
echo "› Seeding pages for Field & Musket Tavern…"
HOME_ID=$(mkpage home "Home" "")
MENU=$(mkpage menu "Menu" "template-menu.blade.php")
RESERVE=$(mkpage reserve "Reservations" "template-reserve.blade.php")
STORY=$(mkpage story "Our Story & Sourcing" "template-story.blade.php")
VISIT=$(mkpage visit "Visit Us in Downtown Gettysburg, PA" "template-visit.blade.php")

wp option update show_on_front page >/dev/null
wp option update page_on_front "$HOME_ID" >/dev/null
wp option update blogname "Field & Musket Tavern" >/dev/null 2>&1 || true
