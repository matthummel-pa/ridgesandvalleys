...
<script type="application/ld+json">
{
  ...
  "hasMenu": {
    "@@type": "Menu",
    "name": "Cannon & Crumb Menu",
    "hasMenuSection": [
      { "@@type": "MenuSection", "name": "Breakfast & Brunch" },
      { "@@type": "MenuSection", "name": "Bakery" },
      { "@@type": "MenuSection", "name": "Lunch" },
      { "@@type": "MenuSection", "name": "Coffee & Drinks" }
    ]
  },
  "address": {
    "@@type": "PostalAddress",
...
<main id="main">
  ...
  <section class="page-hero">
    <div class="container">
      ...
      <h1>Baked fresh. Sourced local. Served all day.</h1>
      <p>Everything on our menu is made from scratch in our Lincoln Square kitchen, using flour, produce, and coffee from right here in Adams County. Browse by category, filter by diet, and add items straight to your order.</p>
    </div>
  </section>
  ...
  <section class="menu-section" id="menu">
    <div class="container">
      <div class="section-head reveal">
        <span class="eyebrow">Browse &amp; Order</span>
        <h2>Pick a category, filter by diet</h2>
        <p>Build your order right here — pickup on the Square or delivery around downtown Gettysburg.</p>
      </div>
  ...
  <section class="hours-section">
    <div class="container">
      <div class="section-head reveal">
        ...
        <h2>Menu &amp; dietary questions</h2>
      </div>
      <div class="faq-list">
        <div class="faq-item reveal">
          <h3>Do you label vegetarian, vegan, and gluten-free items?</h3>
          <p>Yes. Use the Vegetarian, Vegan, and Gluten-free filters above to instantly narrow any category. Tags also appear right on each item card.</p>
        </div>
        <div class="faq-item reveal">
          <h3>Where do your ingredients come from?</h3>
          <p>As close to Gettysburg as we can get them — flour from a mill near Biglerville, produce from Adams County orchards and farm stands, and coffee roasted in small batches just up the road.</p>
        </div>
        <div class="faq-item reveal">
          <h3>Can I order the menu online?</h3>
          <p>Absolutely. Add items to your order from this page, or head to our <a href="{{ home_url('/order/') }}">Order Online</a> page to check out for pickup on the Square or delivery around downtown.</p>
        </div>
        <div class="faq-item reveal">
          <h3>Do you have allergen information?</h3>
          <p>Our team is happy to talk through ingredients and cross-contact for any dish — just ask at the counter or <a href="{{ home_url('/contact/') }}">send us a note</a> before you visit.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="cta-band">
    <div class="container">
      ...
      <p>Add your favorites to an order for a quick pickup on Lincoln Square, or plan catering for a crowd.</p>
      <div class="hero-actions">
        <a href="{{ home_url('/order/') }}" class="btn btn-primary" style="background:var(--espresso);">Order Online</a>
        <a href="{{ home_url('/catering/') }}" class="btn btn-outline">Catering &amp; Events</a>
      </div>
    </div>
  </section>
