...
echo "› Seeding pages for Hallowed Ground Battlefield Tours…"
HOME_ID=$(mkpage home "Home" "")
AREA=$(mkpage area "About Gettysburg & the Battlefield" "template-area.blade.php")
BOOK=$(mkpage book "Book & Pay" "template-book.blade.php")
CONTACT=$(mkpage contact "Contact & FAQ" "template-contact.blade.php")
GUIDES=$(mkpage guides "Your Gettysburg Battlefield Guides" "template-guides.blade.php")
TOURS=$(mkpage tours "Gettysburg Battlefield Tours & Tickets" "template-tours.blade.php")

wp option update show_on_front page >/dev/null
wp option update page_on_front "$HOME_ID" >/dev/null
wp option update blogname "Hallowed Ground Battlefield Tours" >/dev/null 2>&1 || true
