  ...
  <section id="tools" class="rv-shell rv-band">
    ...
    <div class="rv-grid rv-grid-3" style="margin-top:2rem">
      @php($checkers = [
        ...
        ['', __('Accessibility Checker', 'sage'), '/accessibility/', __('Scan any page against WCAG 2.2 AA — the latest W3C standard — with a live, running checklist.', 'sage'), __('Reach more customers and lower your legal risk.', 'sage')],
