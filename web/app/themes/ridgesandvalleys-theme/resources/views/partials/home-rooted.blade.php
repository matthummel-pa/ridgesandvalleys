...
<section class="rv-shell rv-band">
  <div class="rv-split rv-split-reverse">
    ...
    <div class="rv-split-body">
      ...
      <h2 class="rv-section-title" style="margin-top:.3rem">{{ \App\field('rooted_title', __('Built here.', 'sage')) }} <em class="rv-accent">{{ \App\field('rooted_accent', __('Supported', 'sage')) }}</em> {{ \App\field('rooted_title_end', __('here.', 'sage')) }}</h2>
