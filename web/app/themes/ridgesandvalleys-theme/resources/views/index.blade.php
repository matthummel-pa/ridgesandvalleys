...
@section('content')
  @if (is_home() && ! is_front_page())
    ...
    <style>
      ...
      .rv-work-filters{position:static!important;top:auto!important;bottom:auto!important;z-index:auto;padding:.7rem 0;background:transparent;-webkit-backdrop-filter:none;backdrop-filter:none}
