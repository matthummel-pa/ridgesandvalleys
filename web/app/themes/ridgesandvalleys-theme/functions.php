...
collect(['setup', 'filters', 'helpers', 'projects', 'contact', 'customizer', 'integrations', 'blocks', 'tools', 'grader', 'seo-checker', 'security-checker', 'email-checker', 'local-checker', 'page-fields', 'post-fields', 'layout', 'hero-style', 'hero-size', 'hero-credit', 'home-sections', 'ai-edit', 'live-preview', 'seo', 'performance', 'github', 'theme-updater', 'google-photos', 'open-images', 'starter'])
    ->each(function ($file) {
