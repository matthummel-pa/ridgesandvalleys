    ...
    $map = [
        'front-page.blade.php' => [
            ...
            __('Featured work / proof', 'sage') => [
                ...
                ['proof_lede_types', __('Intro under the heading', 'sage'), 'textarea', __('Filter by industry. Three live concepts at a time — screenshot on top, the story underneath.', 'sage')],
                ['proof_cats_label', __('Filter chips label', 'sage'), 'text', __('Show me', 'sage')],
